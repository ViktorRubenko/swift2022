...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        let viewController1 = CurrentLocationViewController()
        let navController1 = CustomNavigationViewController(rootViewController: viewController1)
        ...
        let viewController2 = LocationsViewController()
        let navController2 = CustomNavigationViewController(rootViewController: viewController2)
        ...
        let viewController3 = MapViewController()
        let navController3 = CustomNavigationViewController(rootViewController: viewController3)
